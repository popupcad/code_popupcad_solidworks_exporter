...
Sub export_popupcad()
    ...
    Set strings = BuildPopupCADData(transform, component_info)
...
Sub export_generic()
    ...
    Set transform = view.ModelToViewTransform
    Set strings = BuildYAMLData(transform, component_info)
    'Dim filename As String
    'filename = "C:\Users\danb0b\Desktop\" & model.GetTitle & "_" & view.Name & ".yaml"
    Dim filename2 As String
    filename2 = swApp.GetCurrentWorkingDirectory() & model.GetTitle & "_" & view.Name & ".yaml"
...
Function BuildPopupCADData(viewTransform As SldWorks.mathTransform, components As Collection) As Collection
...
'                If True Then
    ...
    Set BuildPopupCADData = lines
End Function

Function BuildYAMLData(viewTransform As SldWorks.mathTransform, components As Collection) As Collection
    Dim lines As New Collection
    Dim transform As Variant
    Dim transformstring As New Collection
    Dim componentstring As New Collection
